...
export async function render(el){
  const body = `
    <div class="media-frame">
      <img src="assets/climate_poster.jpg" alt="Aerial shot of coastline affected by erosion" />
    </div>
    ...
    <details class="expand">
      ...
      <div class="media-frame" style="margin-top:.5rem;">
        <video src="assets/climate_hero.mp4" poster="assets/climate_poster.jpg" muted loop playsinline controls></video>
      </div>
